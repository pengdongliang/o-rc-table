...
export default () => {
  ...
  const columns = [
    {
      dataIndex: 'index', name: '序号', width: 80, render: (value, record, rowIndex) => {
        return rowIndex + 1
      }
    },
    {
      dataIndex: 'mark', name: '说明', width: 100,
    },
    { dataIndex: 'autoA', name: '自适应1', width: 250, render: renderAutoHeightCell },
    { dataIndex: 'autoB', name: '自适应2', width: 250, render: renderAutoHeightCell }
  ]
