...
import { FormOptionsType, OSearchForm, Space, Spin } from '@ocloud/antd'
import { useRootSubject } from '@table/ProTable/hooks/useRootSubject'
import { useAntdTable, useCreation, useMemoizedFn, useUpdateEffect } from 'ahooks'
...
import { UseTableParamsDataResultType } from './hooks/useTableParamsData'
...
const InternalTable = <RecordType extends AnyObject = AnyObject>(
  ...
  const rootConfig = useRootSubject<RecordType>(props, searchFormRef)
  const finalTableConfig = rootConfig
  ...
  const { tableDataPromise, queryParams, urlSearchParams } = subjectInfo

  const tableParamsData = useAntdTable(tableDataPromise, {
    ...useAntdTableOptions,
    ready: !!useAntdTableOptions,
  })
  ...
  }, [paginationConfig, paginationVisible])
