    ...
    deprecatedTokens.forEach(([oldTokenKey, newTokenKey]) => {
      if (process.env.NODE_ENV !== 'production') {
        warning(
          ...
          `Component Token \`${String(oldTokenKey)}\` of ${component} is deprecated. Please use \`${String(
            newTokenKey
          )}\` instead.`
        )
      }
  ...
  return (prefixCls: string): UseComponentStyleResult => {
    ...
    const wrapSSR = useStyleRegister({ ...sharedConfig, path: [concatComponent, prefixCls, iconPrefixCls] }, () => {
      ...
      const componentToken = getComponentToken(
        component,
        realToken,
        defaultComponentToken as ComponentTokenMap[typeof component],
        {
    ...
    return [wrapSSR, hashId] as UseComponentStyleResult
  }
}
    ...
    useCSSVarRegister(
      ...
      () => {
        ...
        const componentToken = getComponentToken(
          component,
          realToken,
          defaultToken as ComponentTokenMap[typeof component],
          {
            format: options?.format,
            deprecatedTokens: options?.deprecatedTokens,
          }
